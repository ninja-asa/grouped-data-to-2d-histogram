...
settings_histogram = Histogram2DContourSettings(
    ...
    feature_1_bin_size=None,  # set to None to auto calculate bin size of feature 1 in the provided data #TODO: validate this
    feature_2_bin_size=None, #0.01,  # set to None to auto calculate bin size of feature 2 in the provided data #TODO: validate this
    hist_colorbar_min=None,  # set to None to auto calculate minimum value of the colorbar in the provided data #TODO: validate this
    hist_colorbar_max=None,# 7,  # set to None to auto calculate maximum value of the colorbar in the provided data #TODO: validate this
