...
settings_histogram = Histogram2DContourSettings(
    ...
    feature_1_bin_size=25000,  # set to None to auto calculate bin size of feature 1 in the provided data 
    feature_2_bin_size=0.01, #0.01,  # set to None to auto calculate bin size of feature 2 in the provided data 
    hist_colorbar_min=0,  # set to None to auto calculate minimum value of the colorbar in the provided data 
    hist_colorbar_max=4,# 7,  # set to None to auto calculate maximum value of the colorbar in the provided data 
